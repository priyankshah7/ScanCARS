...
"}")
        ...
        self.SpectralAcq_time_req = QtWidgets.QLineEdit(self.group_SpectralAcq)
...
"}")
        ...
        self.HyperAcq_time_req = QtWidgets.QLineEdit(self.group_HyperAcq)
...
"}")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1512, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SpectralAcq_time_req.setText(_translate("MainWindow", "0.005"))
        ...
        self.HyperAcq_time_req.setText(_translate("MainWindow", "0.005"))
