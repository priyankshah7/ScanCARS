...
"}")
        ...
        self.SpectralAcq_time_req.setDecimals(4)
        self.SpectralAcq_time_req.setSingleStep(0.0005)
        self.SpectralAcq_time_req.setProperty("value", 0.005)
...
"}")
        ...
        self.HyperAcq_time_req.setDecimals(4)
        self.HyperAcq_time_req.setSingleStep(0.0005)
        self.HyperAcq_time_req.setProperty("value", 0.005)
