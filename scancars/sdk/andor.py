...
def gettemperature():
    ...
    return ERROR_CODE[error], temperature.value
...
def getacquireddata(acquisitionmode, width, randomtracks):
    """
    ...
    return ERROR_CODE[error], np.asarray(cimage[:])
...
def getstatus():
    ...
    return ERROR_CODE[error], status.value
...
def getdetector():
    ...
    return ERROR_CODE[error], cw.value
...
def getacquisitiontimings():
    ...
    return ERROR_CODE[error], exposure.value
